...
import { FaGithubAlt, FaGithubSquare, FaLink, FaLinkedin, FaLinkedinIn, FaYoutube, FaYoutubeSquare } from 'react-icons/fa'
            ...
            <div className='align-element grid md:grid-cols-2 items-center gap-8'>
                <article>
                    ...
                    <div className='flex gap-x-4 mt-4'>
                        <a href='https://github.com/cvinsf' target='_blank' rel='noreferrer noopener'>
                            <FaGithubSquare className='h-8 w-8 text-slate-500 hover:text-black duration-300' />
                        </a>
                        <a href='https://linkedin.com/in/carlosvillarrealsb' target='_blank' rel='noreferrer noopener'>
                            <FaLinkedinIn className='h-8 w-8 text-slate-500 hover:text-black duration-300' />
                        </a>
                        <a href='https://www.youtube.com/channel/UCm5Pp6cgRNf98XxRR4-MF-Q' target='_blank' rel='noreferrer noopener'>
